...
namespace ACWPD\Futhark;
	...
	class Power {
		...
		public function getBigImageTable() {
			...
			$output .= '<button id="rollType" ic-get-from="/a/roll/type" ic-target="#addedData" ic-replace-target="true">Roll Another</button>' . "\n";
			$output .= '<button id="rollFlavor" ic-get-from="/a/roll/flavor" ic-target="#addedData" ic-replace-target="true">Roll Another</buton>' . "\n";
			$output .= '<button id="rollTwist" ic-get-from="/a/roll/twist" ic-target="#addedData" ic-replace-target="true">Draw Again</button>' . "\n";

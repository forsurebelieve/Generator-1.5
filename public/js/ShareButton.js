...
Share = (function(_super) {
	...
	Share.prototype.network_reddit = function() {
		return this.popup('https://www.reddit.com/r/FutharkGenerator/submit', {
			url: this.config.networks.reddit.url,
			title: '[FutharkPower] ' + this.config.networks.reddit.title
		});
	};
	
	Share.prototype.network_tumblr = function() {
		return this.popup('http://tumblr.com/widgets/share/tool', {
			posttype: 'link',
			title: this.config.networks.tumblr.title,
			content: this.config.networks.tumblr.url
		});
	};
	...
	Share.prototype.inject_html = function(instance) {
		return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-pinterest' data-network='pinterest'></li><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li><li class='non-entypo-reddit' data-network='reddit'></li><li class='entypo-tumblr' data-network='tumblr'></li></ul></div>";
	};
